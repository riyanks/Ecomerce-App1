...
const LoginU = loadable(() => pMinDelay(import('./page/login'), 250), { fallback: <Loading /> });
...
const Recipe = loadable(() => pMinDelay(import('./component/CreateRecipe'), 250), { fallback: <Loading /> });
...
const LoginAdmin = loadable(() => pMinDelay(import('./page/LoginAdmin'), 250), { fallback: <Loading /> });
const SignupAdmin = loadable(() => pMinDelay(import('./page/Signup'), 250), { fallback: <Loading /> });
const HomeAdmin = loadable(() =>pMinDelay (import('./page/Home'), 250), { fallback: <Loading /> });
const MakeProduct = loadable(() =>pMinDelay (import('./page/MakeProduct'), 250), { fallback: <Loading /> });
const GetProduct = loadable(() =>pMinDelay (import('./page/GetProduct'), 250), { fallback: <Loading /> });
    ...
    <>
      <BrowserRouter>
        <Router>
          <ScrollToTop />
          <Switch>
            <Route path='/home' exact component={Fashion} />
            ...
            <Route path='/' exact component={LoginU} />
            ...
            <Route path='/create_recipe' exact component={Recipe} />
            <Route path='/create_product' exact component={MakeProduct} />
            <Route path='/get_product' exact component={GetProduct} />
